...
\033[1;91m☞ Auther     : 4M_ON3_M4N_SHOW_AL3X
\033[1;92m☞ WhatsApp   : 03353397914
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf hassan/B4_BALOCH')
	    os.system('cd hassan && git clone https://github.com/hassanalex/syco')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    time.sleep(2)
	    os.system('cd hassan && python2 alex.py')
	elif bm =='3':
...
def pb():
	...
	print(S+50*'-')
	print
	print(S+'Process has been completed CP ID Open After 1 hour ')
